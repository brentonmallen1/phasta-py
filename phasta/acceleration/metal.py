"""Metal acceleration backend for PHASTA-Py.

This module implements the Metal acceleration backend using PyTorch's Metal
Performance Shaders (MPS) backend for Apple devices.
"""
...
class MetalBackend(AccelerationBackend):
    """Metal acceleration backend using PyTorch's MPS backend."""
    
    def __init__(self):
        """Initialize the Metal backend."""
        self.device = torch.device('mps' if torch.backends.mps.is_available() else 'cpu')
        self._stream = torch.mps.Stream() if torch.backends.mps.is_available() else None
    ...
    def matvec(self, A: Union[sparse.spmatrix, np.ndarray], 
        ...
        """Compute matrix-vector product using Metal.
        ...
        """
        # Convert inputs to PyTorch tensors on MPS device
    ...
    def assemble_element_matrix(self, element_nodes: np.ndarray,
        ...
        """Assemble element matrix using Metal.
        ...
        # Compute element matrix using Metal
    ...
    def compute_element_metrics(self, element_nodes: np.ndarray) -> Tuple[np.ndarray, float]:
        """Compute element metrics using Metal.
    ...
    def parallel_reduce(self, local_data: np.ndarray, 
        ...
        """Perform parallel reduction operation using Metal.
